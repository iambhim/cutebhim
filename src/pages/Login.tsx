    ...
    <div className="auth-container">
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 className="font-brand" style={{ fontSize: '32px', background: 'linear-gradient(135deg, #6C63FF, #FF6584)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
            CuteBhim
          </h1>
          <p style={{ color: 'var(--text-muted)', marginTop: '6px', fontSize: '14px' }}>Welcome back 👋</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
          ...
          <Link to="/signup" style={{ color: 'var(--primary)', fontWeight: 600, fontSize: '14px', textDecoration: 'none' }}>
            Create account
          </Link>
        </div>
      </div>
